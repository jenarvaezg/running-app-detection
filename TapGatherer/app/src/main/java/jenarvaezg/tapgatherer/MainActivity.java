        ...
        startStopSwitch.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (!isChecked) {
                    ...
                    builder.setPositiveButton(R.string.dialog_predict, new DialogInterface.OnClickListener() {
                        @Override
                    ...
                    builder.setNegativeButton(R.string.dialog_train,  new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Intent intent = new Intent(MainActivity.this, SensorGatherService.class);
